...
export default {
  ...
  downloads: {
    ...
    whitepapers: {
      ...
      skycoinWhitepaper: 'Skycoin whitepaper V1.2',
      skycoinWhitepaperV32: 'Skycoin whitepaper V1.2中文版',
  ...
  skyminer: {
    ...
    about: {
      ...
      list: {
        ...
        item4: '64-bit Linux (Debian)',
        item5: '100 Mbps Ethernet, 8+1 port switch',
      },
    },
    video: {
